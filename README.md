...
### Software
The following libraries were used in the injection height estimation algorithm, for creating figures and tables, and for data analysis. All the code and scripts were written in `Python version 3.9.7`, available under the license https://python.org/. 
